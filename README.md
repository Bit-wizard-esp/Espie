...
| 💾 **WRITE KEY** | ✅ Работает | Записать ключ на чистую метку (в разработке) |
...
- **Питание:** tp4056 + li-ion батарея любой емкости
...
### Запись ключа
1. Главное меню → **WRITE KEY**
2. Выберите ключ из сохраненных
3. Приложите ключ к контакту GPIO0 и нажмите **ОК**
